...
def test_transformer(TransformerToTest, df, num_bins=45):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--test_results_fp", type=str, default="test_results.csv", help="Specifies file path to save test reults with default value of 'test_results.csv'")
    ...
    test_results.append(
        test_transformer(getattr(ple_transformer,args.transformer_class), df)
    )
